...
> 历史 README，归档于 2026-09-16。以下是历史设计与操作说明，不是当前功能或安全保证。当前内容见 [README](../../README.md) 与 [实施记录](../implementation-plan.md)。旧截图不随档案恢复。
...
| | |
| --- | --- |
| OS | Windows 10/11 (the app is Windows-only today; see [roadmap](../roadmap.md)) |
